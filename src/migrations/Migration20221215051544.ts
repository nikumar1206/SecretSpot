...
export class Migration20221215051544 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "post" ("id" uuid not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "name" varchar(255) not null, "location" varchar(255) not null, "image_url" varchar(255) not null default \'\', "caption" varchar(255) not null, "attendies" varchar(255) not null, "creator_id" uuid not null, constraint "post_pkey" primary key ("id"));');
