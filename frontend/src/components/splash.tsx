...
const Splash = () => {
	...
	return (
		<>
			...
			{loaded ? (
				<div className="absolute m-auto text-center z-1 text-white w-full h-full flex-col justify-center items-center top-44">
					<article>
						<h1 className="font-h1 text-9xl mt-5 mb-3 font-thin">
							Secret Spot
						</h1>
